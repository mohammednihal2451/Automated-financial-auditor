...
//       const issuesData = await getIssues(reportId);
//       const fraudData = await getFrauds(reportId);
...
//         <h1 className="text-3xl font-bold mb-6">Report #{report.report_id}</h1>

//         {/* SUMMARY CARDS */}
//         <div className="grid grid-cols-3 gap-4 mb-6">
//           <div className="bg-white p-4 rounded-lg shadow">
//             <p className="text-gray-500">Total Rows</p>
//             <p className="text-xl font-bold">{report.total_rows}</p>
//           </div>

//           <div className="bg-white p-4 rounded-lg shadow">
//             <p className="text-gray-500">Issues</p>
//             <p className="text-xl font-bold text-yellow-600">{report.total_issues}</p>
//           </div>

//           <div className="bg-white p-4 rounded-lg shadow">
//             <p className="text-gray-500">Fraud</p>
//             <p className="text-xl font-bold text-red-600">{report.fraud_count}</p>
//           </div>
//         </div>
