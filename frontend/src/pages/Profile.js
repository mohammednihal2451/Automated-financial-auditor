...
//             <div>
//               <p className="font-semibold text-sm">{user.name || "Your Name"}</p>
...
//             <p className="flex justify-between cursor-pointer hover:text-indigo-600">
...
//             </p>
//             <p className="flex justify-between cursor-pointer hover:text-red-500">
//               🚪 Logout
//             </p>
//           </div>
//         </div>
